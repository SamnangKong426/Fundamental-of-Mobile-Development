...
class _HomeState extends State<Home> {
  ...
  // 3. Remove all state drilling and states in every widgets

  @override
  Widget build(BuildContext context) {
    // 4. Wrap the widget who needs the model with a consumer Consumer<ColorCounters>

    /* 
    1. Without Provider: State changes trigger rebuilds of entire widget tree
    2. With Provider: Only Consumer widgets depending on changed data rebuild
    3. Result: Better performance through minimized widget rebuilds
    */
